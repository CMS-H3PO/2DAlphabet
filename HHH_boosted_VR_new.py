    ...
    for working_area in ["{}_boosted_VR".format(options.year)]:
        ...
        for polyOrder in ["0","1","2", "3"]:
            if options.year == "2017":
                if polyOrder in ["1"]:
                    test_fit(working_area,polyOrder,strategy=2, rMin=-5, rMax=5, setParams={'qcd_rpfT_1_par0':'4.1','qcd_rpfT_1_par1':'-3.5','qcd_rpfT_1_par2':'1.0'})
                elif polyOrder in ["2"]:
                    test_fit(working_area,polyOrder,strategy=2, rMin=-1, rMax=1, setParams={'qcd_rpfT_2_par0':'4.3','qcd_rpfT_2_par1':'-5.3','qcd_rpfT_2_par2':'2.8', 'qcd_rpfT_2_par3':'-0.8','qcd_rpfT_2_par4':'2.0','qcd_rpfT_2_par5':'-4.0'})
                elif polyOrder in ["3"]:
                    test_fit(working_area,polyOrder,strategy=2, rMin=-1, rMax=1, setParams={'qcd_rpfT_3_par0':'4.3','qcd_rpfT_3_par1':'-5.3','qcd_rpfT_3_par2':'2.8', 'qcd_rpfT_3_par3':'-0.8','qcd_rpfT_3_par4':'2.0','qcd_rpfT_3_par5':'-4.0'})
                else:
