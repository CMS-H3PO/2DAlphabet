...
if __name__ == '__main__':
    ...
    #sigNames = ["XToYHTo6B_MX-1500_MY-600", "XToYHTo6B_MX-1500_MY-1300", "XToYHTo6B_MX-2000_MY-900", "XToYHTo6B_MX-2000_MY-1600"]
    #rMax = 2
    
    #sigNames = ["XToYHTo6B_MX-1200_MY-300", "XToYHTo6B_MX-1500_MY-800"]
    #rMax = 3

    sigNames = ["XToYHTo6B_MX-1200_MY-1000", "XToYHTo6B_MX-1500_MY-300", "XToYHTo6B_MX-4000_MY-300"]
    rMax = 10
    ...
    for working_area in ["2017_boosted_SR_pass_toy_multiSignal"]:
        ...
        for sig in sigNames:
            print("\nProcessing {0}...\n".format(sig))
            # note that strategy=2 could lead to failed s+b fits but it ensures that the b-only fit properly converges
            # from which the transfer function parameters are taken for the expected limit calculation
            test_fit(polyOrder,sig,strategy=2)
            
            test_limit(working_area,polyOrder,'%s/runConfig.json'%working_area,blind=True,strategy=2,extra=("--rMin=-1 --rMax={0}".format(rMax)))
